...
namespace PMS.Repository.Repositories.Generic
{
    public class GenericRepository<T> : IGenericRepository<T>, IDisposable where T : class
    {
        ...
        public GenericRepository(IUnitOfWork<PMSEntities> unitOfWork) : this(unitOfWork.Context)
        {
        }
        public GenericRepository(PMSEntities context)
        {
            _isDisposed = false;
            Context = context;
        }
        public PMSEntities Context { get; set; }
        ...
        {
            var list = Entities.Where(condition).ToList();
            return list;
        }
        ...
        public virtual T GetByIdAsNoTracking(Func<T, bool> condition)
        {
            return Entities.AsNoTracking().Where(condition).FirstOrDefault();
        }
